...
PLUGINSLUG="restrict-registration-for-wp-members"

# main config, set off of plugin slug
CURRENTDIR=`pwd`
MAINFILE="restrict-registration-wpmem.php" # this should be the name of your main php file in the wordpress plugin
