...
function ntmrr_options() {
	...
	$reg_form_msg = get_option('ntmrr_registration_form_message');
	$error_msg = get_option('ntmrr_email_not_approved_message');
	$redirect = get_option('ntmrr_redirect_on_unapproved');
	$url = get_option('ntmrr_redirect_on_unapproved_url');
	$whitelist = get_option('ntmrr_whitelisted_emails');
	$blacklist = get_option('ntmrr_blacklisted_emails');
	...
	<div class="wrap">
		...
		<input type="hidden" name="ntmrr_posted" value="Y" />
			...
			<div style="width: 49%; float: left;">
				...
				<textarea rows="15" name="ntmrr_whitelisted_emails"><?php echo $whitelist; ?></textarea>
			</div>
			<div style="width: 49%; float: right;">
				...
				<textarea rows="15" name="ntmrr_blacklisted_emails"><?php echo $blacklist; ?></textarea>
			</div>
